...
class Game:
    ...
    def __init__(self):
        ...
        if args.codemaster == "human":
            ...
            self.codemaster = codemaster_module.AICodemaster(brown_ic, glove_vecs_cm, word_vectors)
        ...
        if args.guesser == "human":
            ...
            self.guesser = guesser_module.Guesser(brown_ic, glove_vecs_guesser, word_vectors)
